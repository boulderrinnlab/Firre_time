...
# setting peak to 10Kb up and downstream from peak center
offset <- 1e5
...
# Here you normalizing each time point then summing

# What does it look like if we take the mean of the relative signal per timepoint?
# atac_expression_combined <- combined_expr_peak %>%
